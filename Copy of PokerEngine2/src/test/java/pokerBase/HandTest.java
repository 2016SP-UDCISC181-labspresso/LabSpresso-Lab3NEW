...
public class HandTest {
	...
	public void TestFourOfAKind1() {
		...
		boolean bActualIsHandFourOfAKind = Hand.isHandFourOfAKind(h, hs, null);
	...
	public void TestFiveOfAKind() {
		...
		boolean bActualIsHandFivefAKind = Hand.isHandFiveOfAKind(h, hs, null);
...
////////////////////////////////////////////////////////////////////	
	...
	public void TestStraight1() {
		...
		HandScore hs = new HandScore();// new instance of Handscore
		ArrayList<Card> Straight = new ArrayList<Card>();// create a new arraylist of cards
		////Add cards  
		...
		Collections.sort(Straight);//SORT CARDS
		Hand h = new Hand();//CREATE A NEW INSTANCE OF HAND
		h = SetHand(Straight,h);//set the hand
		
		boolean bActualIsHandStraight = Hand.isHandStraight(h, hs, null);
	...
	public void TestStraightEval1() {
		...
		HandScore hs = new HandScore();//create a new instance of handscore
		...
		try {//try to evaluate hand
			h = Hand.EvaluateHand(h, null);//null is an arraylist of wilds? to be used later...
		} catch (HandException e) {
			e.printStackTrace();
		...
		System.out.println("iActualIsHandStraight: " + iActualIsHandStraight);
	...
	public void TestStraight2() {
		...
		HandScore hs = new HandScore();// Creates a new instance of HandScore
		ArrayList<Card> Straight = new ArrayList<Card>();
		...
		boolean bActualIsHandStraight = Hand.isHandStraight(h, hs, null);// null is an arraylist of eCardNo
		boolean bExpectedIsHandStraight = true;
		
		assertEquals(bActualIsHandStraight,bExpectedIsHandStraight);// True if hand is a straight		
		assertEquals(hs.getHiHand(),eRank.FIVE.getiRankNbr());// True if hi hand is a five of dimonds
	}
	...
	public void TestFlush() {
		...
		HandScore hs = new HandScore();// A new instance of handScore
		...
		boolean bActualIsHandFlush = Hand.isHandFlush(h.getCardsInHand(), hs);// hs is an arraylist of eCardNo?
		boolean bExpectedIsFlush = true;
		
		assertEquals(bActualIsHandFlush,bExpectedIsFlush);// True if the given hand is a flush
		assertEquals(hs.getHiHand(),eRank.NINE.getiRankNbr());// True if hi hand is a nine
	}
	...
	public void TestThreeOfAKind1() {
		...
		boolean bActualIsThreeOfAKind = Hand.isHandThreeOfAKind(h, hs, null);
	...
	public void TestTwoPair1() {
		...
		boolean bActualIsTwoPair = Hand.isHandTwoPair(h, hs, null);
