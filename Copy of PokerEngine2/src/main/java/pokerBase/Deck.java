...
public class Deck {
	...
	/**
	*	private ArrayList<eRank> wildRanks = new ArrayList<eRank>();
	*	wildRanks should be declared in the superclass, and passed to the deck constructor.
	*	Cards that are wild are decided to be so by the game or table.
	/**
	...
	public Deck (int NbrOfJokers, ArrayList<eRank> wildRanks) 
	{
		this(NbrOfJokers);
